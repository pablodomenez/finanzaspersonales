          ...
          <div class="flex items-center gap-2 mt-0.5">
            ...
            <div class="flex items-center gap-1">
              <a href="https://www.instagram.com/pablo.finance?igsh=dnZjczJrbHBsbXQ3&utm_source=qr"
                 ...
                 title="Instagram"
                 class="w-5 h-5 rounded flex items-center justify-center text-white transition-all hover:scale-110 hover:opacity-90"
              ...
              <a href="https://youtube.com/@pablofinance?si=RtLPvrukgIbl-Fh2"
                 target="_blank" rel="noopener noreferrer"
                 title="YouTube"
                 class="w-5 h-5 rounded flex items-center justify-center bg-red-600 hover:bg-red-500 text-white transition-all hover:scale-110">
                <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor">
